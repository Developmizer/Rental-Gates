...
(function($) {
     ...
     */
    RG.showToast = function(message, type, duration) {
        type     = type || 'info';
        duration = duration || 4000;

        var $toast = $('<div>', {
            'class': 'rg-toast rg-toast-' + RG.escapeHtml(type)
        }).append(
        ...
        setTimeout(function() { $toast.addClass('rg-toast-show'); }, 10);
