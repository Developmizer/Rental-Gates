...
<style>
    ...
    .rg-checkbox-group { display: flex; align-items: center; gap: 8px; }
    .rg-checkbox-group input { width: 18px; height: 18px; }
    ...
    .rg-unit-preview.visible { display: block; }
    .rg-unit-preview-title { font-weight: 600; margin-bottom: 8px; }
    .rg-unit-preview-info { display: grid; grid-template-columns: repeat(3, 1fr); gap: 12px; font-size: 13px; }
    .rg-unit-preview-item span { color: var(--gray-500); display: block; }
    
    .rg-tenant-select-section { margin-top: 20px; padding-top: 20px; border-top: 1px solid var(--gray-200); }
    .rg-selected-tenants { display: flex; flex-direction: column; gap: 8px; margin-bottom: 16px; }
    .rg-selected-tenant { 
        display: flex; align-items: center; justify-content: space-between; 
        padding: 10px 12px; background: var(--gray-50); border-radius: 8px; 
    }
    .rg-selected-tenant-info { display: flex; align-items: center; gap: 10px; }
    .rg-selected-tenant-avatar { 
        width: 32px; height: 32px; border-radius: 50%; background: var(--primary); 
        color: #fff; display: flex; align-items: center; justify-content: center; 
        font-size: 12px; font-weight: 600; 
    }
    .rg-add-tenant-row { display: flex; gap: 10px; }
    .rg-add-tenant-row select { flex: 1; }
    
    @media (max-width: 768px) {
        .rg-form-row, .rg-form-row.three-col { grid-template-columns: 1fr; }
        .rg-form-actions { flex-direction: column; }
        .rg-form-actions .rg-btn { width: 100%; }
        .rg-unit-preview-info { grid-template-columns: 1fr 1fr; }
    }
</style>
